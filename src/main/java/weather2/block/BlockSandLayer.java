...
public class BlockSandLayer extends Block
{
    ...
    {
        int i = ((Integer)blockState.get(LAYERS)).intValue();
        float f = 0.125F;
    ...
    public boolean shouldSideBeRendered(BlockState blockState, IBlockAccess blockAccess, BlockPos pos, Direction side)
    {
        ...
        else
        {
            ...
            return iblockstate.getOwner() == this && ((Integer)iblockstate.get(LAYERS)).intValue() >= ((Integer)blockState.get(LAYERS)).intValue() ? true : super.shouldSideBeRendered(blockState, blockAccess, pos, side);
        }
    }
