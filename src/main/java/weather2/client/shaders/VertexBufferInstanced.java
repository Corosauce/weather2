...
public class VertexBufferInstanced implements AutoCloseable {
    ...
    public void _drawWithShader(Matrix4f p_166877_, Matrix4f p_166878_, ShaderInstanceExtended p_166879_) {
        if (this.indexCount != 0) {
    ...
    public void _drawWithShaderDummyEnd(Matrix4f p_166877_, Matrix4f p_166878_, ShaderInstanceExtended p_166879_) {
