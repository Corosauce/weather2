...
public final class Matrix4fe {
    ...
    public Matrix4fe(Matrix4fe p_27621_) {
    ...
    public Matrix4fe(Matrix4f p_27621_) {
        this.m00 = p_27621_.m00;
        this.m01 = p_27621_.m01;
        this.m02 = p_27621_.m02;
        this.m03 = p_27621_.m03;
    ...
    public Matrix4fe(Quaternion p_27623_) {
        float f = p_27623_.i();
        float f1 = p_27623_.j();
        float f2 = p_27623_.k();
        float f3 = p_27623_.r();
    ...
    public boolean isInteger() {
        Matrix4fe matrix4f = new Matrix4fe();
        matrix4f.m30 = 1.0F;
        matrix4f.m31 = 1.0F;
        matrix4f.m32 = 1.0F;
        matrix4f.m33 = 0.0F;
        Matrix4fe matrix4f1 = this.copy();
    ...
    public boolean equals(Object p_27661_) {
        if (this == p_27661_) {
            ...
            Matrix4fe matrix4f = (Matrix4fe)p_27661_;
    ...
    public void load(Matrix4fe p_162211_) {
    ...
    public void multiply(Matrix4fe p_27645_) {
    ...
    public void multiply(Quaternion p_27647_) {
        this.multiply(new Matrix4fe(p_27647_));
    }
    ...
    public void add(Matrix4fe p_162225_) {
    ...
    public void subtract(Matrix4fe p_162228_) {
    ...
    public static Matrix4fe perspective(double p_27626_, float p_27627_, float p_27628_, float p_27629_) {
    ...
    public static Matrix4fe orthographic(float p_27637_, float p_27638_, float p_27639_, float p_27640_) {
        Matrix4fe matrix4f = new Matrix4fe();
    ...
    public static Matrix4fe orthographic(float p_162204_, float p_162205_, float p_162206_, float p_162207_, float p_162208_, float p_162209_) {
        Matrix4fe matrix4f = new Matrix4fe();
    ...
    public Matrix4fe copy() {
        return new Matrix4fe(this);
    }
    ...
    public static Matrix4fe createScaleMatrix(float p_27633_, float p_27634_, float p_27635_) {
        Matrix4fe matrix4f = new Matrix4fe();
    ...
    public static Matrix4fe createTranslateMatrix(float p_27654_, float p_27655_, float p_27656_) {
        Matrix4fe matrix4f = new Matrix4fe();
        matrix4f.m00 = 1.0F;
        matrix4f.m11 = 1.0F;
        matrix4f.m22 = 1.0F;
    ...
    public void multiplyBackward(Matrix4fe other) {
        Matrix4fe copy = other.copy();
        copy.multiply(this);
        this.load(copy);
    }
