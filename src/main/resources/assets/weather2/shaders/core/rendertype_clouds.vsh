...
void main() {
    ...
    Position3 = vec3(Position.x + Color.x * 10, Position.y + Color.y * 1, Position.z + Color.z * 10);
    ...
    //vertexColor = Color;
    vertexColor = Color2;
    vertexColor = vec4(Color.xyz * 0.06, 1);
